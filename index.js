    ...
    render: function(){
        ...
        return (
            <div>
                ...
                <div className="input"><Button onClick={this.onAddSubmit} /></div>
    ...
    render: function(){
        ...
        return (
            <div>
                ...
                <div><input type="text" placeholder="new card" onChange={this.onAddInputChanged} /> </div>
                <div><button onClick={this.onAddSubmit} />Add Card</div>
